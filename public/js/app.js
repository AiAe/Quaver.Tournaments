...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var downloadButtons = document.getElementsByClassName("download-round");
  var downloadInGameButtons = document.getElementsByClassName("download-ingame-round");

  if (downloadButtons) {
    var _iterator = _createForOfIteratorHelper(downloadButtons),
        _step;
  ...
  if (downloadInGameButtons) {
    var _iterator2 = _createForOfIteratorHelper(downloadInGameButtons),
        _step2;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        _button.addEventListener('click', downloadInGameRound, false);
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  function downloadRound() {
    var round = this.dataset.round;
    var maps = document.getElementById(round).getElementsByClassName('download');
  ...
  function downloadInGameRound() {
    ...
    if (maps.length) {
      var _iterator4 = _createForOfIteratorHelper(maps),
          _step4;
